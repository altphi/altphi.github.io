...
- **stack**: first in last out, faster than heap, fixed size known at compile time
- **heap**: slower because memory allocator has to hunt for usable/free space and
at read time pointers to non-contiguous space have to be followed, dynamically sized at runtime
